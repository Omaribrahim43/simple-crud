            ...
            <div class="container-fluid px-4">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <form class="forms-sample" action="{{ route('admin.employees.update', $employee->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-6">
                                    <div class="col-md-12 col-xl-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" value="{{ $employee->first_name }}" class="form-control @error('fname') is-invalid @enderror"
                                                name="fname">
                                            @error('fname')
                                ...
                                <div class="col-6">
                                    <div class="col-md-12 col-xl-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" value="{{ $employee->last_name }}" class="form-control @error('lname') is-invalid @enderror"
                                                name="lname">
                                            @error('lname')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                            ...
                            <div class="col-md-12 col-xl-12">
                                <div class="mb-3">
                                    ...
                                    <input type="email" value="{{ $employee->email }}" class="form-control @error('email') is-invalid @enderror"
                                        name="email">
                                    @error('email')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
